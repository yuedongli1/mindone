...
class AutoencoderKL(nn.Cell):
    def __init__(
        ...
        self.quant_conv = Conv2d(2 * ddconfig["z_channels"], 2 * embed_dim, 1, pad_mode="valid", has_bias=True)
        self.post_quant_conv = Conv2d(embed_dim, ddconfig["z_channels"], 1, pad_mode="valid", has_bias=True)
